...
K_MUTEX_DEFINE(k_cracen_mutex_asymmetric);
nrf_security_mutex_t cracen_mutex_asymmetric = {.zephyr_mutex = &k_cracen_mutex_asymmetric };
#else
nrf_security_mutex_t cracen_mutex_asymmetric;
#endif
