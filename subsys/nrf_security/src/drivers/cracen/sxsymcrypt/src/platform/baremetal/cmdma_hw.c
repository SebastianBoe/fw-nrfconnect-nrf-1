...
K_MUTEX_DEFINE(k_cracen_mutex_symmetric);
nrf_security_mutex_t cracen_mutex_symmetric = { .zephyr_mutex = &k_cracen_mutex_symmetric };
#else
nrf_security_mutex_t cracen_mutex_symmetric;
#endif
