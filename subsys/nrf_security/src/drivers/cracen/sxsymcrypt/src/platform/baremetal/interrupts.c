...
K_EVENT_DEFINE(k_cracen_irq_event_for_cryptomaster);
K_EVENT_DEFINE(k_cracen_irq_event_for_pke);
nrf_security_event_t cracen_irq_event_for_cryptomaster = { .zephyr_event = &k_cracen_irq_event_for_cryptomaster };
nrf_security_event_t cracen_irq_event_for_pke = { .zephyr_event = &k_cracen_irq_event_for_pke };
#else
nrf_security_event_t cracen_irq_event_for_cryptomaster;
nrf_security_event_t cracen_irq_event_for_pke;
#endif
