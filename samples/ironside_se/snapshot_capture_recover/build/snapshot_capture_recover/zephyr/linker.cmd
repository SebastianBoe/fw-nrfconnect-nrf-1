...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0xe000000 + 0x30000), LENGTH = (0x62000 - 0x0)
    RAM (wx) : ORIGIN = 0x2f000000, LENGTH = (760 * 1K)
    DEVNULL_ROM (rx) : ORIGIN = ((0xe000000 + 0x30000) + (0x62000 - 0x0)), LENGTH = 262144
    DMA_RAM3x_APP ( rw ) : ORIGIN = (801185792), LENGTH = (4096) APP_RAM0 ( rw ) : ORIGIN = (570425344), LENGTH = (32512) PMLocalRamfunc ( rw ) : ORIGIN = (570457856), LENGTH = (192) pm_s2ram_stack ( rw ) : ORIGIN = (570458056), LENGTH = (16) mcuboot_s2ram_context ( rw ) : ORIGIN = (570458072), LENGTH = (8) pm_s2ram_context ( rw ) : ORIGIN = (570458080), LENGTH = (32)
 ...
 *(".kernel.*")
 ...
 net_buf_pool_area : ALIGN_WITH_INPUT { _net_buf_pool_list_start = .; KEEP(*(SORT_BY_NAME(._net_buf_pool.static.*))); _net_buf_pool_list_end = .;; } > RAM AT > FLASH
    __data_region_end = .;
periphconf_entry (COPY) : SUBALIGN(4)
{
 _periphconf_entry_list_start = .; KEEP(*(SORT_BY_NAME(._periphconf_entry.static.*))); _periphconf_entry_list_end = .;;
} > DEVNULL_ROM
