...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_STMESP_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x62000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_IRONSIDE_SE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_IRONSIDE_SE_CALL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IRONSIDE_SE_CALL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IRONSIDE_SE_CALL_ZEPHYR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IRONSIDE_SE_CALL_INIT_PRIORITY, 41);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PERIPHCONF_SECTION_STRIP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PERIPHCONF_GENERATE_ENTRIES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PERIPHCONF_GENERATE_ENTRIES_LOCK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_NRF54H, 1);
